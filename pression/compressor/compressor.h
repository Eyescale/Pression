...
#ifndef PRESSION_PLUGIN_COMPRESSOR
#define PRESSION_PLUGIN_COMPRESSOR
...
/**
 * @file pression/compressor/compressor.h
 *
 * Compression plugins provided with Pression.
 */
namespace pression
{
namespace plugin
...
#endif // PRESSION_PLUGIN_COMPRESSOR
